...
export const caseStudies: CaseStudy[] = [
  {
    ...
    accentTo: "#EC4899",
    challenge: {
      p1: "[VoiceValet](https://govoicevalet.com/) helps businesses answer every call with a smart AI that qualifies prospects, books appointments, and pushes clean data into the CRM, without adding human headcount. But the category is noisy and crowded.",
      ...
      attribution: "Aidan Mattrick, CEO, [VoiceValet](https://govoicevalet.com/)"
    },
    solution: {
      ...
      p2: "Over the course of three months,BoostMyRank delivered 15 backlinks (5 per month) from respected business and technology outlets, all in an automated way through matching VoiceValet to journalist requests.",
      p3: "Every month, we provided VoiceValet with a report with all the backlinks we secured, including the URL, anchor, DA, status, and impact highlights thir team could share in exec meetings.",
    ...
    impact: {
      ...
      p2: "At the same time, VoiceValet was able to create an \"As Seen In\" section and media badges for the homepage to increase their social proof.",
