...
export const caseStudies: CaseStudy[] = [
  {
    ...
    subtitle: "Learn how a personal trainer marketing agency increased organic pipeline through strategic editorial placement and credibility building with BoostMyRank.",
  ...
  },
  {
    ...
    subtitle: "Learn how an AI phone-answering service increased demo requests and organic traffic with BoostMyRank.",
    ...
    solution: {
      p1: "BoostMyRank executed an automated editorial outreach program that matched VoiceValet's CEO to journalist requests on their area of expertise.",
    ...
    impact: {
      p1: "In 6 months, VoiceValet's domain authority rose 12 points, organic sessions grew 150%, and demo requests increased 60%, while customer acquisition costs (CAC) decreased 22% due to stronger organic performance.",
  ...
  },
  {
    ...
    title: "Case Study: How Loch boosted organic traffic nearly 70% in 90 days by improving its backlinking strategy",
    subtitle: "Learn how an online news site covering global market trends broke through page-one competition and established domain authority with BoostMyRank.",
    ...
    challenge: {
      ...
      attribution: "Prithvir Jhaveri, Founder, <a href='https://loch.one/' target='_blank' rel='noopener noreferrer' style='color: #2563eb; text-decoration: underline;'>Loch</a>"
    },
    solution: {
      ...
      p2: "This enabled <a href='https://loch.one/' target='_blank' rel='noopener noreferrer' style='color: #2563eb; text-decoration: underline;'>Loch</a> to create a simple \"As Seen In\" section and media badges for the homepage, article templates, and author bios to showcase credibility.",
      p3: "BoostMyRank provided a completely hands-off workflow: We sourced opportunities, drafted quotes in the <a href='https://loch.one/' target='_blank' rel='noopener noreferrer' style='color: #2563eb; text-decoration: underline;'>Loch</a> voice, handled submissions and follow-ups, and provided monthly reports on newspaper placements (URL, anchor, DA, status).",
