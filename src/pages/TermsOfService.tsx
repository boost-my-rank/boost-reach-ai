    ...
    <>
      ...
      <LegalPageLayout>
        <LegalContent title="Terms of Service">
          <LegalSection>
            <LegalHeading>1. User's Acknowledgment and Acceptance of Terms</LegalHeading>
            <LegalParagraph>
          ...
          <LegalSection>
            <LegalHeading>2. Membership</LegalHeading>
            <LegalParagraph>
          ...
          <LegalSection>
            <LegalHeading>3. Account Ownership</LegalHeading>
            <LegalParagraph>
